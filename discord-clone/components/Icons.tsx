...
export function DiscordIcon({ className = 'w-6 h-6' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      ...
      className={className}
    >
      <path d='M107.7 8.07A105.15 105.15 0 0081.47 0a72.06 72.06 0 00-3.36 6.83 97.68 97.68 0 00-29.11 0A72.37 72.37 0 0045.64 0a105.89 105.89 0 00-26.25 8.09C2.79 32.65-1.71 56.6.54 80.21a105.73 105.73 0 0032.17 16.15 77.7 77.7 0 006.89-11.11 68.42 68.42 0 01-10.85-5.18c.91-.66 1.8-1.34 2.66-2a73.57 73.57 0 0064.32 0c.87.68 1.76 1.36 2.66 2a68.68 68.68 0 01-10.87 5.19 77.7 77.7 0 006.89 11.1 105.25 105.25 0 0032.19-16.14c2.64-27.38-4.51-51.11-18.9-72.15zM42.45 65.69c-6.57 0-12-6.04-12-13.44s5.32-13.44 12-13.44c6.74 0 12.09 6.09 12 13.44 0 7.4-5.3 13.44-12 13.44zm42.24 0c-6.57 0-12-6.04-12-13.44s5.32-13.44 12-13.44c6.74 0 12.09 6.09 12 13.44 0 7.4-5.26 13.44-12 13.44z'/>
    </svg>
  );
}

export function HashIcon({ className = 'w-5 h-5' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
    ...
    >
      <path
        strokeLinecap='round'
        strokeLinejoin='round'
        d='M5.25 8.25h13.5m-16.5 7.5h13.5m-1.5-12l-3.75 16.5m-3-16.5l-3.75 16.5'
      />
    </svg>
  );
}